...
output "alb_id" {
  ...
  description = "ALB ID for production environment"
}

output "alb_arn" {
  value       = module.environment.alb_arn
  description = "ALB ARN for production environment"
}

output "alb_dns_name" {
  value       = module.environment.alb_dns_name
  description = "ALB DNS name for production environment"
}

output "alb_zone_id" {
  value       = module.environment.alb_zone_id
  description = "ALB hosted zone ID for production environment"
}

output "waf_id" {
  value       = module.environment.waf_id
  description = "WAF ID for production environment"
}

output "waf_arn" {
  value       = module.environment.waf_arn
  description = "WAF ARN for production environment"
}

output "waf_name" {
  value       = module.environment.waf_name
  description = "WAF name for production environment"
}
