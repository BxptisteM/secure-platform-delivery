...
output "kms_key_id" {
  ...
  description = "KMS Key ID for staging environment"
}
...
output "public_subnet_ids" {
  ...
  description = "Public subnet IDs for staging environment"
}

output "private_app_subnet_ids" {
  value       = module.environment.private_app_subnet_ids
  description = "Private application subnet IDs for staging environment"
}

output "private_db_subnet_ids" {
  value       = module.environment.private_db_subnet_ids
  description = "Private database subnet IDs for staging environment"
}

output "alb_security_group_id" {
  value       = module.environment.alb_security_group_id
  description = "ALB security group ID for staging environment"
}

output "app_security_group_id" {
  value       = module.environment.app_security_group_id
  description = "Application security group ID for staging environment"
}

output "db_security_group_id" {
  value       = module.environment.db_security_group_id
  description = "Database security group ID for staging environment"
}

output "db_subnet_group_name" {
  value       = module.environment.db_subnet_group_name
  description = "DB subnet group name for staging environment"
}

output "alb_id" {
  value       = module.environment.alb_id
  description = "ALB ID for staging environment"
}

output "alb_arn" {
  value       = module.environment.alb_arn
  description = "ALB ARN for staging environment"
}

output "alb_dns_name" {
  value       = module.environment.alb_dns_name
  description = "ALB DNS name for staging environment"
}

output "alb_zone_id" {
  value       = module.environment.alb_zone_id
  description = "ALB hosted zone ID for staging environment"
}
